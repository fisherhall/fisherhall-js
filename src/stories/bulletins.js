...
storiesOf("BulletinHeader", module)
  .add("default state", () => {
    const bulletin = {name:"Sunday Worship Service", publishedAt:"2019-07-21T13:30:00+00:00"}

    return (
      <BrowserRouter>
        <BulletinHeader bulletin={bulletin} onNavBarClick={action("nav bar clicked")} />
      </BrowserRouter>
    )
  })

storiesOf("Bulletin", module)
  .add("default state", () => {
    const bulletin = {
